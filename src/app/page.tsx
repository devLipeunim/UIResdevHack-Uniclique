    ...
    <main className="d-flex  justify-content-center flex-column width-100">
          ...
          >
            ...
            <h1 className=" creating  position-absolute mt-5">
              ...
              Made for <Typewriter
                options={{
                  strings: [
                    "Unibadan, by Unibadan.",
                    "Shopping.",
                    "Students Enterpreneurs.",
                    "Food Vendors.",
                    "Delivery Services.",
                    "Fashion Designers.",
                    "Event Promotions.",
      ...
      <section className="d-flex  justify-content-center">
        <div className="containeR d-flex justify-content-between flex-wrap">
          <div className="d-flex flex-column width-50 left">
            ...
            <div data-aos="fade-up">
              ...
              <p className="mt-1 subPoints">
                ...
                audience, boost visibility and thrive with seamless marketing
            ...
            <div data-aos="fade-up">
              ...
              <p className="mt-1 subPoints">
                ...
                products, engage students and launch a thriving digital
                storefront that drives success
              </p>
            </div>
          ...
          <div className="aboutImage width-50"></div>
        </div>
      </section>
